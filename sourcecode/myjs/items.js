$(function() {
  ...
  var togglePanel = function(show) {
    $orderPanel.animate({ left: show ? 0 : -$orderPanel.outerWidth()});
  };
  ...
  $(window).resize(function() {
    if($orderPanel.offset().left < 0) {
      $orderPanel.offset({ left: -$orderPanel.outerWidth() });
    }
  });
